                    ...
                    _.extend = function(e) {
                        ...
                        _.throttle = function(e, t, r) {
                            ...
                            return function() {
                                ...
                                return s = this,
                                    n = arguments,
                                    u <= 0 || u > t ? (i && (clearTimeout(i), i = null), o = d, a = e.apply(s, n), i || (s = n = null)) : i || r.trailing === !1 || (i = setTimeout(c, u)),
                                    a
                            }
                        },
                        ...
                        _.base64Encode = function(e) {
                            ...
                            do t = e.charCodeAt(u++),
                                ...
                                i = c >> 6 & 63,
                                o = 63 & c,
                                f[p++] = d.charAt(n) + d.charAt(a) + d.charAt(i) + d.charAt(o);
                            while (u < e.length);
                        ...
                        _.cookie = {
                            ...
                            set: function(e, t, r, s, n) {
                                ...
                                if (0 !== r) {
                                    var d = new Date;
                                    "s" === String(r).slice( - 1) ? d.setTime(d.getTime() + 1e3 * Number(String(r).slice(0, -1))) : d.setTime(d.getTime() + 24 * r * 60 * 60 * 1e3),
            ...
            sd.sendState = sendState,
                ...
                sendState.getSendCall = function(e, t, r) {
                    ...
                    if (e = JSON.stringify(e), this.requestData = {
                        ...
                        sd.events.tempAdd("send", s), !sd.para.use_app_track && sd.para.batch_send && localStorage.length < 200) return sd.log(s),
                        sd.batchSend.add(this.requestData.data),
                        !1;
                    if (sd.para.use_app_track === !0 || "only" === sd.para.use_app_track) if ("object" == typeof SensorsData_APP_JS_Bridge && (SensorsData_APP_JS_Bridge.sensorsdata_verify || SensorsData_APP_JS_Bridge.sensorsdata_track)) SensorsData_APP_JS_Bridge.sensorsdata_verify ? SensorsData_APP_JS_Bridge.sensorsdata_verify(JSON.stringify(_.extend({
                    ...
                    else if (!/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream) sd.para.use_app_track === !0 && sd.para.use_app_track_is_send === !0 && (sd.debug.apph5({
                        data: s,
                        step: "2",
                        output: "all"
                            ...
                            r = t({
                                ...
                                func: function(e, t) {
                                    var r = document.documentElement && document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop || 0,
                                        s = new Date,
                                        n = s - this.current_time; (n > sd.para.heatmap.scroll_delay_time && r - e.$viewport_position !== 0 || t) && (e.$url = location.href, e.$title = document.title, e.$url_path = location.pathname, e.event_duration = Math.min(sd.para.heatmap.scroll_event_duration, parseInt(n) / 1e3), sd.track("$WebStay", e)),
                                        this.current_time = s
                                }
                            });
                    ...
                    initHeatmap: function() {
                        ...
                        return ! (!_.isObject(sd.para.heatmap) || "default" !== sd.para.heatmap.clickmap) && (!(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all": sd.para.heatmap.collect_elements = "interact", void("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click",
                            ...
                            function(t) {
                                ...
                                if (!s || !s.parentNode || !s.parentNode.children) return ! 1;
                                var a = s.parentNode;
                                if ("a" === n || "button" === n || "input" === n || "textarea" === n || _.hasAttribute(s, "data-sensors-click")) e.start(r, s, n);
